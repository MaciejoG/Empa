...
Rcond_tank=d_pp/(k_pp*(pi*r_tank^2+2*pi*r_tank*H_tank))+d_steel/(k_steel*(pi*r_tank^2+2*pi*r_tank*H_tank)); % conductive restistance of tank's material, K/W
...
save('Results_model_v13_tc_varrying_Tdhw')
