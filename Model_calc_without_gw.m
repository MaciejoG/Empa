...
clc
close all
load('Results_model_v13_tc_varrying_Tdhw_without_gw')
...
grid on
print('no_gw_Temperatures_in_time','-dpd')
...
legend('Troom','Tgw','Tsurface','T1.5','T3.5','Tceiling')
grid on
print('no_gw_Temperatures_in_time_during_day_number_31','-dpd')
